...
public class DataPage {
    ...
    public static final Target SELECT_TRANSFER_TRANSACCION = Target.the("Transaccion bancolobmia")
            .locatedBy("//*[@id='sandboxStatus']");
    ...
    public static final Target TXT_INFORMATION_TRANSFER = Target.the("informacion de la transaccioN")
            .locatedBy("///*[@class='src-components-App-__App__title__Y13rn']");
